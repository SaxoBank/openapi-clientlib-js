 ...
 */
var PriceFormatOptions = enumUtils.makeDefinition([
	...
	/** @member {string} saxo.priceFormatOptions.NoRounding - Indicates that no rounding should be done - that decimals should be treated as a max decimals. */
	"NoRounding"]);

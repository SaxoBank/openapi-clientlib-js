 ...
 * 2. The ability to wait for a promise to complete see {@link saxo.openapi.TransportQueue#waitFor}. The old library had an option initLoadBalancerCookies which did
 ...
 * @param {saxo.openapi.TransportAuth|saxo.openapi.TransportBatch|saxo.openapi.TransportCore|saxo.openapi.TransportQueue} transport - The transport to wrap.
 * @param {saxo.openapi.TransportAuth} [transportAuth] - Provides the relevant TransportAuth. If given then calls will be queued whilst the auth is expired.
